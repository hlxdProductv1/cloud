...
public class TechnologyStandardServiceImpl extends ServiceImpl<TechnologyStandardMapper, TechnologyStandard> implements TechnologyStandardService {
	...
	@Override
	public Page<TechnologyStandardVo> list(Page<TechnologyStandardVo> page, String standardName,
			String technologyCode) {
		return page.setRecords(technologyStandardMapper.list(page, standardName, technologyCode));
	}
