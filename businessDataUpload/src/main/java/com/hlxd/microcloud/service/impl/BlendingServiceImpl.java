...
import com.hlxd.microcloud.entity.BlendingDetails;
...
public class BlendingServiceImpl implements BlendingService {
    ...
    @Override
    public void batchInsert(List<Blending> list) {
        blendingMapper.batchInsert(list);
    }

    @Override
    public void batchInsertDetails(List<BlendingDetails> blendingDetails) {
        blendingMapper.batchInsertDetails(blendingDetails);
    }
}
