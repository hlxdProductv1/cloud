...
public class VerificationServiceImpl implements IVerificationService {
    ...
    @Override
    public void batchInsert(List<Verification> verifications) {
        verificationMapper.batchInsert(verifications);
    }

    @Override
    public void batchInsertDetails(List<VerificationDetails> verificationDetails) {
        verificationMapper.batchInsertDetails(verificationDetails);
    }
}
